        ...
        <div class="header">    
            <div class="header-content clearfix">
               ...
               <div class="text-center">
                <h2 class="pt-3"> Human Resource Management System </h2>
                 </div>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                   <br> <br>       
                    ...
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Project</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./add-project.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Add Project</span></a></li>
                            <li><a href="./assign-project.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Assign Project</span></a></li>
                            <li><a href="./manage-project.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Manage Projects</span></a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="./emp-on-eave.php" >
                            <i class="fa fa-tasks menu-icon"></i><span class="nav-text">Employee On Leave</span>
                        </a>
                    </li>
